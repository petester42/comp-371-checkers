...
bitset<gameLogic::BIT_DEPTH> gameLogic::generateAcceptedMoves(int player, int index)
{
	...
	if(player == 0)
	{
		bitset<BIT_DEPTH> selectedPos;
		selectedPos.set(index, 1);

		potentialMoves |= calculateLeftTop(selectedPos, whitePieces, leftTopMask);
		potentialMoves |= calculateLeftDown(selectedPos, whitePieces, leftDownMask);
		potentialMoves |= calculateRightUp(selectedPos, whitePieces, rightTopMask);
		potentialMoves |= calculateRightDown(selectedPos, whitePieces, rightDownMask);
	}
	else if(player == 1)
	{
		bitset<BIT_DEPTH> selectedPos;
		...
		potentialMoves |= calculateLeftTop(selectedPos, blackPieces, leftTopMask);
		potentialMoves |= calculateLeftDown(selectedPos, blackPieces, leftDownMask);
		potentialMoves |= calculateRightUp(selectedPos, blackPieces, rightTopMask);
		potentialMoves |= calculateRightDown(selectedPos, blackPieces, rightDownMask);
	}
...
void gameLogic::performMove(int player, bitset<BIT_DEPTH> intendedMove)
{
	bitset<BIT_DEPTH> pointsToCapture;

	if(player == 0)
	{
		pointsToCapture |= captureUp(intendedMove, whitePieces, blackPieces, upMask);
		pointsToCapture |= captureDown(intendedMove, whitePieces, blackPieces, downMask);
		pointsToCapture |= captureLeft(intendedMove, whitePieces, blackPieces, leftMask);
		pointsToCapture |= captureRight(intendedMove, whitePieces, blackPieces, rightMask);
		pointsToCapture |= captureLeftTop(intendedMove, whitePieces, blackPieces, leftTopMask);
		pointsToCapture |= captureLeftDown(intendedMove, whitePieces, blackPieces, leftDownMask);
		pointsToCapture |= captureRightTop(intendedMove, whitePieces, blackPieces, rightTopMask);
		pointsToCapture |= captureRightDown(intendedMove, whitePieces, blackPieces, rightDownMask);

		blackPieces |= pointsToCapture;
		blackPieces |= intendedMove;
		whitePieces ^= pointsToCapture;
	}
	else if(player == 1)
	{
		pointsToCapture |= captureUp(intendedMove, blackPieces, whitePieces, upMask);
		pointsToCapture |= captureDown(intendedMove, blackPieces, whitePieces, downMask);
		pointsToCapture |= captureLeft(intendedMove, blackPieces, whitePieces, leftMask);
		pointsToCapture |= captureRight(intendedMove, blackPieces, whitePieces, rightMask);
		pointsToCapture |= captureLeftTop(intendedMove, blackPieces, whitePieces, leftTopMask);
		pointsToCapture |= captureLeftDown(intendedMove, blackPieces, whitePieces, leftDownMask);
		pointsToCapture |= captureRightTop(intendedMove, blackPieces, whitePieces, rightTopMask);
		pointsToCapture |= captureRightDown(intendedMove, blackPieces, whitePieces, rightDownMask);

		whitePieces |= pointsToCapture;
		whitePieces |= intendedMove;
		blackPieces ^= pointsToCapture;
	}
...
bitset<gameLogic::BIT_DEPTH> gameLogic::calculateLeftTop(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = currentPlayer | secondPlayer;
	emptyPos.flip();
...
bitset<gameLogic::BIT_DEPTH> gameLogic::calculateLeftDown(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = currentPlayer | secondPlayer;
	emptyPos.flip();
	bitset<64> emptySec = emptyPos | secondPlayer;
...
bitset<gameLogic::BIT_DEPTH> gameLogic::calculateRightUp(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = currentPlayer | secondPlayer;
	emptyPos.flip();
	bitset<64> emptySec = emptyPos | secondPlayer;
...
bitset<gameLogic::BIT_DEPTH> gameLogic::calculateRightDown(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = currentPlayer | secondPlayer;
	emptyPos.flip();
	bitset<64> emptySec = emptyPos | secondPlayer;
...
bitset<gameLogic::BIT_DEPTH> gameLogic::captureLeftTop(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = intendedMove | secondPlayer;
	emptyPos.flip();
...
bitset<gameLogic::BIT_DEPTH> gameLogic::captureLeftDown(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = intendedMove | secondPlayer;
	emptyPos.flip();
...
bitset<gameLogic::BIT_DEPTH> gameLogic::captureRightTop(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = intendedMove | secondPlayer;
	emptyPos.flip();
...
bitset<gameLogic::BIT_DEPTH> gameLogic::captureRightDown(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask)
{
	bitset<64> emptyPos = intendedMove | secondPlayer;
	emptyPos.flip();
