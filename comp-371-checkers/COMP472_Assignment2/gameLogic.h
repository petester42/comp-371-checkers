...
public:
	...
	void performMove(int player, bitset<BIT_DEPTH> intendedMove);
	...
	bitset<BIT_DEPTH> calculateLeftTop(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> calculateLeftDown(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> calculateRightUp(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> calculateRightDown(bitset<BIT_DEPTH> currentPlayer, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> mask);
	...
	bitset<BIT_DEPTH> captureLeftTop(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> captureLeftDown(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> captureRightTop(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask);
	bitset<BIT_DEPTH> captureRightDown(bitset<BIT_DEPTH> intendedMove, bitset<BIT_DEPTH> secondPlayer, bitset<BIT_DEPTH> firstPlayer, bitset<BIT_DEPTH> mask);
